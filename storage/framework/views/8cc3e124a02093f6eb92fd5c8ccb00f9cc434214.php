...
<div class="px-3 py-2 flex flex-col justify-center items-center h-[70vh]">
    <div class="flex flex-row leading-normal border shadow-md rounded-lg max-w-3xl min-w-[50%] bg-white max-h-[96%] min-h-[50%]">
        <div class="flex flex-col justify-center h-full max-h-[] max-w-[60%] min-w-[50%]">
            <img src="<?php echo e($food['picture']); ?>" class='object-cover xl:rounded-l-lg h-full'>
        </div>
        <div class="flex flex-col p-4 h-full flex-grow">
            <div class="flex-grow flex flex-col justify-around">
                <h1 class="font-bold font-sans text-2xl leading-8"><?php echo e($food['name']); ?></h1>
                <h1 class="font-semibold font-sans text-lg text-red-500 leading-8">₹ <?php echo e($food['price']); ?></h1>
                <h1 class="font-serif text-sm text-gray-600 leading-7"><?php echo e($food['description']); ?></h1>
            </div>
            <div class="pt-3 flex flex-col flex-grow justify-around">
                <div>
                    ...
                    <div class="inline-flex rounded-md border-2">
                        ...
                        <p class="py-2 px-3 text-sm m-0" id="qty" data-object="<?php echo e(json_encode($food)); ?>">1</p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\food11\resources\views/food/show.blade.php ENDPATH**/ ?>
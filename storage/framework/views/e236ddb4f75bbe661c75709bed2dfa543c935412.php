        ...
        <div>
          <div class="col-span-3 sm:col-span-2">
            ...
            <div class="mt-1 flex flex-col rounded-md">
              <input required type="text" name="name" id="name" class="shadow-sm <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?> resize-none p-1 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-lg border border-gray-300 rounded-md" placeholder="Tasty cheeseburger with pickles"></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <div class="mt-1 flex flex-col rounded-md">
              <input required type="number" name="price" id="price" class="shadow-sm <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <select name="type" id="type" class="flex justify-center mt-1 flex rounded-md shadow-sm p-1 border focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-lg border-gray-300">>
            <option value="FastFood">Fast Food's</option>
        ...
        <div class="mt-3">
          ...
          <div class="mt-1 flex flex-col rounded-md">
              <input required type="text" name="picture" id="picture" class="shadow-sm <?php $__errorArgs = ['picture'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\food\resources\views/food/addfood.blade.php ENDPATH**/ ?>
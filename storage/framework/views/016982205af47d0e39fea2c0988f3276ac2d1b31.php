        ...
        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="px-3 py-2">
                <div class="flex flex-row p-4 leading-normal border shadow-md hover:bg-gray-100">
                    <div class="p-2 w-1/5">
                        <p class="mb-1"> Order ID: <span class="font-semibold"> <?php echo e($order->id); ?> </span> </p>
                        <p class="mb-1"> Date: <span class="font-semibold"> <?php echo e(date_format(date_create($order->date), 'jS F Y')); ?> </span> </p>
                        <p class="mb-1"> Type: <span class="font-semibold capitalize"> <?php echo e($order->type); ?> </span> </p>
                        <p class="mb-1"> Address: <span class="font-semibold capitalize"> <?php echo e($order->deliveryAddress); ?> </span> </p>
                        
                        <div class="mt-2">
                            <button onclick="remove_form_action(<?php echo e($order->id); ?>)" type="button" class="openRemoveModal text-red-700 font-semibold bg-inherit border-red-500 rounded hover:text-white hover:bg-red-500 hover:border-transparent py-1 px-3 border-2">
                    ...
                    <div class="w-4/5">
                        <div class="flex flex-col justify-between">
                            ...
                            <input type="hidden" id="food_id" value=<?php echo e($food->id); ?> />
                            <div class="flex flex-col items-center -white rounded-lg border shadow-md md:flex-row md:max-w-full hover:bg-gray-100">
                                <div class="flex rounded-lg">
                                    <img class="flex h-28 w-44 object-fill rounded-lg" src="<?php echo e($food->picture); ?>" alt="">
                                </div>
                                <div class="flex flex-col place-content-center px-4 py-3 leading-normal w-4/6">
                                    ...
                                    <p class="flex font-normal text-gray-700"> Quantity: <b>&nbsp;<?php echo e($food->pivot->quantity); ?></b> </p>
                                    <p class="flex font-normal text-gray-700"> T: <b>&nbsp;₹<?php echo e(number_format((float)($food->price*$food->pivot->quantity), 2, '.', '')); ?> &ensp;</b> <span class="opacity-60"> [₹<?php echo e(number_format((float)($food->price), 2, '.', '')); ?> per unit] <span> </p>
                                </div>
                            </div>
                            <div class="p-1"></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\food11\resources\views/order.blade.php ENDPATH**/ ?>
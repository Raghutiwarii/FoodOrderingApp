...
<h1 class="px-4 pt-1 pb-3 text-3xl font-bold">
    <div class="flex flex-row">
        ...
        <div class="flex-1 text-right text-2xl self-center">
            ...
            <span class="mr-8 "> Total: ₹<?php echo e(number_format((float)($total), 2, '.', '')); ?> </span>
            <?php endif; ?>
        </div>
    </div>
</h1>
...
<?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $food): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="px-3 py-2">
            ...
            <div class="flex flex-col justify-between">
                <div class="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-full hover:bg-gray-100">
                    <div class="flex rounded-lg">
                        <img class="flex h-28 w-44 object-fill rounded-lg" src="<?php echo e($food['picture']); ?>">
                    </div>
                    <div class="flex flex-col place-content-center px-4 py-3 leading-normal w-4/6">
                        <h5 class="flex mb-2 text-2xl font-bold tracking-tight text-gray-900"> <?php echo e($food['name']); ?> </h5>
                        <p class="flex font-normal text-gray-700"> Quantity: <b>&nbsp;<?php echo e($food['quantity']); ?></b> </p>
                        <p class="flex font-normal text-gray-700"> Price: <b>&nbsp;₹<?php echo e(number_format((float)($food['price']*$food['quantity']), 2, '.', '')); ?> &ensp;</b> <span class="opacity-60"> [₹<?php echo e(number_format((float)($food['price']), 2, '.', '')); ?> per unit] <span> </p>
                    </div>
                    <div class="flex justify-center leading-normal w-1/6">
                        <button onclick="remove_form_action(<?php echo e($food['id']); ?>)" type="button" class="openRemoveModal text-red-700 font-semibold bg-inherit border-red-500 rounded hover:text-white hover:bg-red-500 hover:border-transparent py-1 px-3 border-2">
                            <span> Remove </span>
                        </button>
                    </div>
                </div>
            ...
            <form method="POST" action="/cart/placeorder" class="px-4 pt-2 pb-4" name="place-order-form" id="place-order-form">
                ...
                <div class="p-6 flex-grow">
                    ...
                    <div class="hidden" id="address_div">
                        ...
                        <?php if(Auth::user()): ?>
                        <textarea rows="3" class="resize-none shadow-sm appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-1 leading-tight focus:outline-none focus:shadow-outline" id="address" name="address"><?php echo e(Auth::user() -> address); ?></textarea>
                        <?php endif; ?>
                        <span class="">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\food11\resources\views/cart.blade.php ENDPATH**/ ?>
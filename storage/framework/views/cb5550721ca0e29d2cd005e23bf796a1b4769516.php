...
<div class="flex flex-col items-center">
    <div class="flex flex-col items-center w-4/5">
        ...
        <table class="p-10 border-collapse border bg-white">
            ...
            <tbody>
                <tr>
                    <td class="border px-2 py-2"><?php echo e($order['id']); ?></td>
                    <td class="border px-2 py-2"><?php echo e($order['name']); ?></td>
                    <td class="border px-2 py-2"><?php echo e($order['description']); ?></td>
                    <td class="border px-2 py-2"><?php echo e($order['price']); ?></td>
                    <td class="border px-2 py-2"><?php echo e($order['type']); ?></td>
                    <td class="border px-2 py-2"><?php echo e($order['picture']); ?></td>
                    <td class="border px-2 py-2">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $order)): ?>
                        <form action="/updatefood/<?php echo e($order['id']); ?>" method="GET">
                            <?php echo csrf_field(); ?>
                    ...
                    <td class="border px-2 py-2">
                        ...
                        <form action="/food/<?php echo e($order['id']); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\food\resources\views/food/placedOrders.blade.php ENDPATH**/ ?>